          ...
          <div class="checkout_details_area clearfix">
            ...
            <form action="includes/processing/processor.php" method="POST">
                       <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label for="message" >Question about Template</label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label for="link" >Link without "HTTP://"</label>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control" name="status">
                                    <option style="background-color:rgba(40, 58, 90, 0.9)" disabled selected>Access Status</option>
                                    <?php
