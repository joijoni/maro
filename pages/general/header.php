...
<header id="header" class="fixed-top ">
          ...
          <?php if(isset($_SESSION['user'])){
            ...
            <?php }?>
                <li class="dropdown"><a class="nav-link" href="#"><span>RESOURCES</span> <i class="bi bi-chevron-down"></i></a>                                                     <ul>
                        ...
                        {
                        ?>
                    <li><a class="nav-link" href="category.php?id=<?php echo $rowd->category_id;?>"><?php echo strtoupper($rowd->name);?></a></li>
                    <?php } ?>
                    </ul>
                </li> 
  ...
  <?php 
	if (!empty($_SESSION['msg'])){?>
			<div class="col-sm-12 alert <?php echo $_SESSION['msgtype'];?> alert-dismissable fade in">
